function cssm() {
    ...
    #panels .webpanel-stack .webpanel footer {
        position: absolute;
        margin-top: 0;
        bottom: 10px;
        right: 130px;
    }
    #panels .webpanel-stack .webpanel footer .toolbar-statusbar {
...
(function panel_actions(){
    ...
    const DEFAULT_ZOOM = 0.8; /* the default zoom % for webpanels; 0.7 equates to 70%, 1 to 100% */
    ...
    */
    ...
    const ACTIONS = {
        ...
        invert: {
            ...
            display: `<svg viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
